...
#/*********************************************/
	def Display(self, ThisSurface, xOffset = 0, yOffset = 0):
		...
		if self.Style == STYLE_GAGUE:
			...
			pygame.draw.line(self.ThisSurface, self.BackgroundColour, (OriginX, OriginY), (OriginX + PointerX, OriginY + PointerY), self.PointerWidth)
			
			PointerX = (.75 * Radius) * math.sin((math.pi / 180) * (-360 * PointerRatio))
			PointerY = (.75 * Radius) * math.cos((math.pi / 180) * (-360 * PointerRatio))
			pygame.draw.line(self.ThisSurface, self.PointerColour, (OriginX, OriginY), (OriginX + PointerX, OriginY + PointerY), int(self.PointerWidth/3))
