...
#/**************************************************************/
#/* Return the xLen of the sub classed visual object instance. */
#/**************************************************************/
	def GetXLen(self):
		return self.xLen
...
#/**************************************************************/
#/* Return the yLen of the sub classed visual object instance. */
#/**************************************************************/
	def GetYLen(self):
		return self.yLen
...
#/***************************************************************/
#/* Set the size of the sub classed visual object instance. */
#/***************************************************************/
	def SetLen(self, xLen, yLen):
		self.xLen = xLen
		self.yLen = yLen
